...
#define PLATFORM_TYPE "ro.zygote"


#define ZYGOTE64_32  "zygote64_32"
#define ZYGOTE32_64  "zygote32_64"
#define ZYGOTE64   "zygote64"
#define ZYGOTE32   "zygote32"

/*900a: zygote64_32 trace_data>30m  | 705a:zygote32 trace_data>21m*/

#define TRACE_NEED_BUFFER_SIZE_DOUBLE_ARCH 32000   //32m

#define TRACE_NEED_BUFFER_SIZE_SINGLE_ARCH 24000   //24m
